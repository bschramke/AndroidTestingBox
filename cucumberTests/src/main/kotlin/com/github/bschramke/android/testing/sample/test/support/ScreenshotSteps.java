package com.github.bschramke.android.testing.sample.test.support;
...
import com.github.bschramke.android.testing.sample.test.actions.ScreenshotAction;
...
/**
 * {@see https://github.com/sebaslogen/CleanGUITestArchitecture/blob/master/app/src/androidTest/java/com/neoranga55/cleanguitestarchitecture/cucumber/steps/HelperSteps.java}
 */
public class ScreenshotSteps {
    ...
    public static void before(final Scenario scenario) {
        ScreenshotSteps.scenario = scenario;
        grantWritePermissionsForScreenshots();
    }

    public static Scenario getScenario() {
        return ScreenshotSteps.scenario;
    }

    @After
    public static void after() {
        if ((ScreenshotSteps.scenario != null) && (ScreenshotSteps.scenario.isFailed())) {
    ...
    public static void takeScreenshot(final String tag) {
        ...
        ScreenshotAction.perform(tag);
        final File screenshot = ScreenshotAction.getLastScreenshot();
        if (screenshot == null) {
